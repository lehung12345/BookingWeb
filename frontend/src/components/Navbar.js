  ...
  return (
    <nav className="navbar" id="main-navbar">
      <div className="navbar-container">
        {/* ✅ LOGO */}
        <Link to={logoTo} className="navbar-logo">
        ...
        <div className="navbar-links">
          {!isAuthenticated ? (
            ...
            <>
              ...
              <Link
                to="/doctor/schedule"
                className={`nav-link ${isActive('/doctor/schedule') ? 'active' : ''}`}
              >
            ...
            <>
              ...
              <Link
                ...
                className={`nav-link ${isActive('/admin/specialties') ? 'active' : ''}`}
              >
                Chuyên khoa
              </Link>
